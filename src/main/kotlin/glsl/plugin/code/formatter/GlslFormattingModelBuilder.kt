    ...
    */
    ...
    private fun createSpaceBuilder(settings: CodeStyleSettings): SpacingBuilder {
        ...
        return SpacingBuilder(settings, GlslLanguage.INSTANCE)
            ...
            .betweenInside(LEFT_ANGLE, PP_INCLUDE_PATH, PP_INCLUDE_DECLARATION).none()
            .betweenInside(PP_INCLUDE_PATH, RIGHT_ANGLE, PP_INCLUDE_DECLARATION).none()
            .betweenInside(SLASH, PP_INCLUDE_PATH, PP_INCLUDE_DECLARATION).none()
            .betweenInside(PP_INCLUDE_PATH, SLASH, PP_INCLUDE_DECLARATION).none()
            ...
            .between(FUNCTION_HEADER, FUNC_HEADER_WITH_PARAMS).none()
