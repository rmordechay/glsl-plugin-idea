...
vec4 textureGrad(sampler3D _sampler, P, vec3 dPdx, vec3 dPdy);
ivec4 textureGrad(isampler3D _sampler, P, vec3 dPdx, vec3 dPdy);
uvec4 textureGrad(usampler3D _sampler, P, vec3 dPdx, vec3 dPdy);
...
ivec2 imageSize(readonly writeonly image);
